...
use ZF\ApigilityAdmin\Model\DbConnectedRestServiceModel;
use ZF\ApigilityAdmin\Model\DbConnectedRestServiceEntity;
...
class DbConnectedRestServiceModelTest extends TestCase
{
    ...
    public function testOnFetchWillRecastEntityToDbConnectedIfDbConnectedConfigurationExists()
    {
        ...
        $this->assertInstanceOf('ZF\ApigilityAdmin\Model\DbConnectedRestServiceEntity', $result);
