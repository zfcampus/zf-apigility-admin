...
use ZF\ApigilityAdmin\Model\DbAdapterModel;
...
class DbAdapterModelTest extends TestCase
{
    ...
    {
        $this->configPath       = sys_get_temp_dir() . '/zf-api-first-admin/config';
    ...
    public function testCanRetrieveListOfAllConfiguredAdapters()
    {
        ...
        foreach ($adapters as $adapter) {
            $this->assertInstanceOf('ZF\ApigilityAdmin\Model\DbAdapterEntity', $adapter);
    ...
    public function testUpdatesLocalDbConfigWhenUpdating()
    {
        ...
        $this->assertInstanceOf('ZF\ApigilityAdmin\Model\DbAdapterEntity', $entity);
