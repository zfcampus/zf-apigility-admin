...
use ZF\ApigilityAdmin\Model\RestServiceModel;
use ZF\ApigilityAdmin\Model\NewRestServiceEntity;
use ZF\ApigilityAdmin\Model\RestServiceEntity;
...
class RestServiceModelTest extends TestCase
{
    ...
    public function testCreateServiceReturnsRestServiceEntityOnSuccess()
    {
        ...
        $this->assertInstanceOf('ZF\ApigilityAdmin\Model\RestServiceEntity', $result);
    ...
    public function testCanFetchServiceAfterCreation()
    {
        ...
        $this->assertInstanceOf('ZF\ApigilityAdmin\Model\RestServiceEntity', $service);
    ...
    public function testUpdateServiceReturnsUpdatedRepresentation()
    {
        ...
        $this->assertInstanceOf('ZF\ApigilityAdmin\Model\RestServiceEntity', $updated);
    ...
    public function testCanDeleteAService()
    {
        ...
        $this->setExpectedException('ZF\ApigilityAdmin\Exception\RuntimeException', 'find', 404);
