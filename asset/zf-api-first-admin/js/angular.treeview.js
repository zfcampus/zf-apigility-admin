	...
	angular.module( 'angularTreeview', [] ).directive( 'treeModel', function( $compile ) {
		return {
			...
			link: function ( scope, element, attrs ) {
				...
				var template = 
					'<ul>' + 
						'<li data-ng-repeat="node in ' + treeModel + '" class="' + nodeIcon + '">' + 
							...
							'<div data-ng-hide="node.collapsed" data-tree-model="node.' + nodeChildren + '" data-node-id=' + nodeId + ' data-node-label=' + nodeLabel + ' data-node-children=' + nodeChildren + ' data-node-icon=' + nodeIcon + '></div>' + 
						'</li>' + 
					'</ul>'; 
