    ...
    angular.module('ag-test', [
        ...
        function($provide, $stateProvider, $urlRouterProvider) {
            ...
            $stateProvider.state('ag.settings.authentication', {
                ...
                views: {
                    'content@': {
                        templateUrl: 'html/settings/authentication.html'
                    }
                }
            });
            $stateProvider.state('ag.settings.content-negotiation', {
                ...
                views: {
                    'content@': {
                        templateUrl: 'html/settings/content-negotiation.html'
                    }
                }
            });
            $stateProvider.state('ag.settings.db-adapters', {
                ...
                views: {
                    'content@': {
                        templateUrl: 'html/settings/db-adapters.html'
                    }
                }
            });
