...
(function (_) {
  'use strict';
  angular.module('ag-admin').controller('ApiAuthorizationController', [
    '$http',
    '$rootScope',
    '$scope',
    '$routeParams',
...
(function () {
  'use strict';
  angular.module('ag-admin').controller('ApiCreateController', [
    '$rootScope',
    '$scope',
    '$location',
    '$timeout',
...
(function (_) {
  'use strict';
  angular.module('ag-admin').controller('ApiDocumentationController', [
    '$rootScope',
    '$scope',
    '$location',
    '$timeout',
      ...
      if (typeof $scope.$parent.restService != 'undefined') {
        ...
        _.forEach($scope.service.collection_http_methods, function (allowed_method) {
          if (typeof $scope.service.documentation.collection[allowed_method] == 'undefined') {
            $scope.service.documentation.collection[allowed_method] = {
              description: null,
              request: null,
              response: null
            };
        ...
        _.forEach($scope.service.resource_http_methods, function (allowed_method) {
          if (typeof $scope.service.documentation.entity[allowed_method] == 'undefined') {
            $scope.service.documentation.entity[allowed_method] = {
              description: null,
              request: null,
              response: null
            };
        ...
        _.forEach($scope.service.http_methods, function (allowed_method) {
          if (typeof $scope.service.documentation[allowed_method] == 'undefined') {
            $scope.service.documentation[allowed_method] = {
              description: null,
              request: null,
              response: null
            };
...
(function () {
  'use strict';
  angular.module('ag-admin').controller('ApiListController', [
    '$rootScope',
    '$scope',
    'ApiRepository',
    function ($rootScope, $scope, ApiRepository) {
      ...
      $scope.refreshApiList = function () {
        ApiRepository.getList(true).then(function (apis) {
          $scope.apis = apis;
        });
      };
      $rootScope.$on('refreshApiList', function () {
...
(function () {
  'use strict';
  angular.module('ag-admin').controller('ApiOverviewController', [
    '$http',
    '$rootScope',
    '$scope',
    'flash',
    'api',
    'ApiRepository',
    function ($http, $rootScope, $scope, flash, api, ApiRepository) {
      $scope.api = api;
...
(function (_) {
  'use strict';
  angular.module('ag-admin').controller('ApiRestServicesController', [
    '$http',
    '$rootScope',
    '$scope',
    '$timeout',
    ...
    function ($http, $rootScope, $scope, $timeout, $sce, flash, filters, hydrators, validators, selectors, ApiRepository, api, dbAdapters, toggleSelection) {
      $scope.ApiRepository = ApiRepository;
      $scope.flash = flash;
      $scope.api = api;
...
(function (_) {
  'use strict';
  angular.module('ag-admin').controller('ApiRpcServicesController', [
    '$http',
    '$rootScope',
    '$scope',
    '$timeout',
    ...
    function ($http, $rootScope, $scope, $timeout, $sce, flash, filters, validators, selectors, ApiRepository, api, toggleSelection) {
      ...
      $scope.removeRpcService = function (rpcServiceName) {
        ApiRepository.removeRpcService($scope.api.name, rpcServiceName).then(function (data) {
...
(function (_) {
  'use strict';
  angular.module('ag-admin').controller('ApiServiceInputController', [
    '$scope',
    'flash',
    function ($scope, flash) {
      ...
      $scope.addInput = function () {
        ...
        $scope.service.input_filter.push({
          name: $scope.newInput,
          required: true,
          filters: [],
          validators: []
...
(function () {
  'use strict';
  angular.module('ag-admin').controller('ApiVersionController', [
    '$rootScope',
    '$scope',
    '$location',
    '$timeout',
...
(function () {
  'use strict';
  angular.module('ag-admin').controller('AuthenticationController', [
    '$scope',
    'flash',
    ...
    function ($scope, flash, AuthenticationRepository) {
      ...
      var fetchAuthenticationDetails = function (force) {
        AuthenticationRepository.fetch({ cache: !force }).then(function (authentication) {
      ...
      var createAuthentication = function (options) {
        AuthenticationRepository.createAuthentication(options).then(function success(authentication) {
      ...
      var updateAuthentication = function (options) {
        ...
        AuthenticationRepository.updateAuthentication(options).then(function success(authentication) {
      ...
      $scope.removeAuthentication = function () {
        AuthenticationRepository.removeAuthentication().then(function (response) {
...
(function (_) {
  'use strict';
  angular.module('ag-admin').controller('ContentNegotiationController', [
    '$scope',
    '$location',
    'flash',
    'selectors',
...
(function () {
  'use strict';
  angular.module('ag-admin').controller('DashboardController', [
    '$rootScope',
    'flash',
...
(function (_, $) {
  'use strict';
  angular.module('ag-admin').controller('DbAdapterController', [
    '$scope',
    '$location',
    'flash',
    'DbAdapterResource',
  ...
  angular.module('ag-admin').directive('collapse', function () {
    return {
      ...
      link: function (scope, element, attr) {
        if (attr.hasOwnProperty('show') && typeof scope.show === 'function') {
          if (!scope.show()) {
  ...
  angular.module('ag-admin').directive('agEditInplace', function () {
    return {
      ...
      link: function (scope, element, attr) {
        ...
        if (attr.hasOwnProperty('validate') && typeof scope.validate === 'function') {
    ...
    function ($http, $templateCache, $compile) {
      return {
        ...
        link: function (scope, element, attr) {
          ...
          $http.get(attr.src, { cache: $templateCache }).success(function (response) {
...
(function () {
  ...
  angular.module('ag-admin').directive('agTabs', function () {
    return {
      ...
      template: '<div class="ag-tabs">' + '<ul class="nav">' + '<li ng-repeat="pane in panes" ng-class="{active:pane.selected}">' + '<a href="" ng-click="select(pane)">{{pane.title}}</a>' + '</li>' + '</ul>' + '<div class="tab-content" ng-transclude></div>' + '</div>',
      replace: true
    };
...
(function (Hyperagent) {
  'use strict';
  angular.module('ag-admin').factory('ApiAuthorizationRepository', [
    '$rootScope',
    '$q',
    '$http',
    'apiBasePath',
    function ($rootScope, $q, $http, apiBasePath) {
      return {
...
(function (_, Hyperagent) {
  'use strict';
  angular.module('ag-admin').factory('ApiRepository', [
    '$rootScope',
    '$q',
    '$http',
    'apiBasePath',
    function ($rootScope, $q, $http, apiBasePath) {
      ...
      return {
        ...
        createNewApi: function (name) {
          return $http.post(moduleApiPath, { name: name }).then(function (response) {
            return response.data;
          });
        },
        createNewRestService: function (apiName, restServiceName) {
          return $http.post(moduleApiPath + '/' + apiName + '/rest', { resource_name: restServiceName }).then(function (response) {
            return response.data;
          });
        },
        createNewDbConnectedService: function (apiName, dbAdapterName, dbTableName) {
          return $http.post(moduleApiPath + '/' + apiName + '/rest', {
            adapter_name: dbAdapterName,
        ...
        createNewRpcService: function (apiName, rpcServiceName, rpcServiceRoute) {
          return $http.post(moduleApiPath + '/' + apiName + '/rpc', {
            service_name: rpcServiceName,
            route: rpcServiceRoute
          }).then(function (response) {
            return response.data;
          });
        },
        ...
        getSourceCode: function (apiName, className) {
          return $http.get(apiBasePath + '/source?module=' + apiName + '&class=' + className).then(function (response) {
            return response.data;
          });
        },
...
(function () {
  'use strict';
  angular.module('ag-admin').factory('AuthenticationRepository', [
    '$http',
    '$q',
    'apiBasePath',
    function ($http, $q, apiBasePath) {
      ...
      return {
        hasAuthentication: function () {
          return this.fetch({ cache: false }).then(function success(response) {
            var configured = true;
            if (response === '') {
              configured = false;
            }
        ...
        fetch: function (options) {
          return $http.get(authenticationPath, options).then(function (response) {
            return response.data;
          });
        },
        createAuthentication: function (options) {
          return $http.post(authenticationPath, options).then(function (response) {
            return response.data;
          });
        },
        ...
        removeAuthentication: function () {
          return $http.delete(authenticationPath).then(function (response) {
            return true;
          }, function (error) {
            return false;
          });
...
(function () {
  'use strict';
  angular.module('ag-admin').factory('ContentNegotiationResource', [
    '$http',
    'flash',
    'apiBasePath',
    function ($http, flash, apiBasePath) {
      ...
      return {
        prepareSelector: function (selector) {
          var data = { content_name: selector.content_name };
...
(function (_, Hyperagent) {
  'use strict';
  angular.module('ag-admin').factory('DbAdapterResource', [
    '$http',
    '$q',
    '$location',
    'apiBasePath',
    function ($http, $q, $location, apiBasePath) {
      ...
      resource.createNewAdapter = function (options) {
        return $http.post(dbAdapterApiPath, options).then(function (response) {
          return response.data;
        });
      };
      resource.saveAdapter = function (name, data) {
        return $http({
          method: 'patch',
          url: dbAdapterApiPath + '/' + encodeURIComponent(name),
          data: data
        }).then(function (response) {
          return response.data;
        });
      ...
      resource.removeAdapter = function (name) {
        return $http.delete(dbAdapterApiPath + '/' + encodeURIComponent(name)).then(function (response) {
          return true;
        });
      };
      return resource;
...
(function () {
  'use strict';
  angular.module('ag-admin').factory('FiltersServicesRepository', [
    '$http',
    'flash',
    'apiBasePath',
    function ($http, flash, apiBasePath) {
...
(function () {
  'use strict';
  angular.module('ag-admin').factory('HydratorServicesRepository', [
    '$http',
    'flash',
    'apiBasePath',
    function ($http, flash, apiBasePath) {
...
(function () {
  'use strict';
  angular.module('ag-admin').factory('toggleSelection', function () {
...
(function () {
  'use strict';
  angular.module('ag-admin').factory('ValidatorsServicesRepository', [
    '$http',
    'flash',
    'apiBasePath',
    function ($http, flash, apiBasePath) {
