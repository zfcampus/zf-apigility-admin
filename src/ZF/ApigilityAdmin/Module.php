...
class Module
{
    ...
    public function getServiceConfig()
    {
        return array('factories' => array(
            'ZF\ApigilityAdmin\Model\DbAdapterModel' => function($services) {
                if (!$services->has('Config')) {
                    throw new ServiceNotCreatedException(
                        'Cannot create ZF\ApigilityAdmin\Model\DbAdapterModel service because Config service is not present'
                    );
                }
            ...
            'ZF\ApigilityAdmin\Model\DbAdapterResource' => function($services) {
                if (!$services->has('ZF\ApigilityAdmin\Model\DbAdapterModel')) {
                    throw new ServiceNotCreatedException(
                        'Cannot create ZF\ApigilityAdmin\Model\DbAdapterResource service because ZF\ApigilityAdmin\Model\DbAdapterModel service is not present'
                    );
                }
                $model = $services->get('ZF\ApigilityAdmin\Model\DbAdapterModel');
                return new Model\DbAdapterResource($model);
            },
            'ZF\ApigilityAdmin\Model\ModuleModel' => function ($services) {
                if (!$services->has('ModuleManager')) {
                    throw new ServiceNotCreatedException(
                        'Cannot create ZF\ApigilityAdmin\Model\ModuleModel service because ModuleManager service is not present'
                    );
                }
            ...
            'ZF\ApigilityAdmin\Model\ModuleResource' => function ($services) {
                $moduleModel = $services->get('ZF\ApigilityAdmin\Model\ModuleModel');
            ...
            'ZF\ApigilityAdmin\Model\RestServiceModelFactory' => function ($services) {
                if (!$services->has('ZF\Configuration\ModuleUtils')
                    ...
                    throw new ServiceNotCreatedException(
                        'ZF\ApigilityAdmin\Model\RestServiceModelFactory is missing one or more dependencies from ZF\Configuration'
                    );
                }
                ...
                $sharedEvents->attach(__NAMESPACE__ . '\Model\RestServiceModel', 'fetch', 'ZF\ApigilityAdmin\Model\DbConnectedRestServiceModel::onFetch');

                return new Model\RestServiceModelFactory($moduleUtils, $configFactory, $sharedEvents);
            },
            'ZF\ApigilityAdmin\Model\RpcServiceModelFactory' => function ($services) {
                if (!$services->has('ZF\Configuration\ModuleUtils')
                    || !$services->has('ZF\Configuration\ConfigResourceFactory')
                    || !$services->has('SharedEventManager')
                ) {
                    throw new ServiceNotCreatedException(
                        'ZF\ApigilityAdmin\Model\RpcServiceModelFactory is missing one or more dependencies from ZF\Configuration'
                    );
                }
                $moduleUtils   = $services->get('ZF\Configuration\ModuleUtils');
                $configFactory = $services->get('ZF\Configuration\ConfigResourceFactory');
            ...
            'ZF\ApigilityAdmin\Model\RestServiceResource' => function ($services) {
                if (!$services->has('ZF\ApigilityAdmin\Model\RestServiceModelFactory')) {
                    throw new ServiceNotCreatedException(
                        'ZF\ApigilityAdmin\Model\RestServiceResource is missing one or more dependencies'
                    );
                }
                $factory = $services->get('ZF\ApigilityAdmin\Model\RestServiceModelFactory');
                return new Model\RestServiceResource($factory);
            },
            'ZF\ApigilityAdmin\Model\RpcServiceResource' => function ($services) {
                if (!$services->has('ZF\ApigilityAdmin\Model\RpcServiceModelFactory')) {
                    throw new ServiceNotCreatedException(
                        'ZF\ApigilityAdmin\Model\RpcServiceResource is missing one or more dependencies'
                    );
                }
                $factory = $services->get('ZF\ApigilityAdmin\Model\RpcServiceModelFactory');
    ...
    {
        return array('factories' => array(
            'ZF\ApigilityAdmin\Controller\ModuleCreation' => function ($controllers) {
                $services = $controllers->getServiceLocator();
                $model    = $services->get('ZF\ApigilityAdmin\Model\ModuleModel');
    ...
    public function onRender($e)
    {
        ...
        if ($controller != 'ZF\ApigilityAdmin\Controller\Module') {
            return;
        }
